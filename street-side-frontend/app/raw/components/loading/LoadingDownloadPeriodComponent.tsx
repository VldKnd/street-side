        ...
        <div className="animate-pulse border-2 border-company-grey rounded-2xl">
            <div className="m-3">
                ...
                <div className="flex rounded-2xl">
                    <div className="place-self-center text-company-grey mr-4 text-opacity-0">
                        From:
                    </div>
                    ...
                    <div className="bg-company-grey flex grow rounded-2xl text-foreground-white text-opacity-0">
