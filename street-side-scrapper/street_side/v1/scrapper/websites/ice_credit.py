...
def iosco_filter(table_row) -> bool:
    ...
    return "ICE Clear Credit" in row_text and "DOWNLOAD" in row_text
...
def find_and_filter_links(web_page: WebPage) -> Tuple[
    ...
    try:
        driver.find_element(
            by=By.XPATH,
            value='//*[@id="integration-id-dd193e6"]/div/div[1]/div/button[1]'
        ).click()
        time.sleep(1)
    except:
        pass
    ...
    try:
        while True:
            driver.find_element(
                by=By.XPATH,
                value='//*[@id="integration-id-dd193e6"]/div/div[2]/div[1]/div[2]/div[2]/ul/li[7]/a'
            ).click()
