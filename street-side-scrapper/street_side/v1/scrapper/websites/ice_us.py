...
def iosco_filter(table_row) -> bool:
    ...
    return "ICE Clear U.S." in row_text and "DOWNLOAD" in row_text
...
def find_and_filter_links(web_page: WebPage) -> Tuple[
    ...
    try:
        driver.find_element(
            by=By.XPATH,
            value='//*[@id="integration-id-dd193e6"]/div/div[1]/div/button[3]'
        ).click()
        time.sleep(1)
    except:
        pass
    ...
    try:
        while True:
            driver.find_element(
                by=By.XPATH,
                value='//*[@id="integration-id-dd193e6"]/div/div[2]/div[3]/div[2]/div[2]/ul/li[7]/a'
            ).click()
    ...
    scrapped_company = Company(
        short_name="ICE US",
        full_name="Intercontinental Exchange Credit (ICE US)",
        home_url=home_url,
        created_at=None,
        updated_at=None
    )
